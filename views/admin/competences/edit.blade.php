...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50/30 to-fuchsia-50/20 py-8">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-purple-900">Edit Competence</h1>
                <p class="text-purple-600 mt-1">Update the skill definition for {{ $competence->code }}.</p>
            </div>
        ...
        <div class="bg-purple-50 rounded-2xl border border-purple-200/60 shadow-xl overflow-hidden">
            <form action="/admin/competences/update" method="POST" class="p-8 space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="code" value="{{ $competence->code }}" required placeholder="e.g., C1, C7, RE-01" 
                    ...
                    <div>
                        ...
                        <textarea name="label" required rows="4" placeholder="Describe the skill or competency in detail..." 
                                  class="w-full px-4 py-2 border border-purple-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-purple-500 transition-all bg-purple-50/50 resize-none">{{ $competence->label }}</textarea>
                    </div>
                </div>
