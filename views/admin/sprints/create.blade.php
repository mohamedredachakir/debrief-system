...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50/30 to-fuchsia-50/20 py-8">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-purple-900">Create Sprint</h1>
                <p class="text-purple-600 mt-1">Configure a new learning sprint and assign it to classes.</p>
            </div>
            
            <a href="{{ $default_class_id ? '/admin/classes/sprints?class_id=' . $default_class_id : '/admin/sprints' }}" class="p-2 border border-purple-200 rounded-lg hover:bg-purple-50 text-slate-500 transition-colors">
        ...
        <div class="bg-purple-50 rounded-2xl border border-purple-200/60 shadow-xl overflow-hidden">
            <form action="/admin/sprints/store" method="POST" class="p-8 space-y-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="name" required placeholder="e.g., Sprint 1: HTML/CSS Fundamentals" 
                ...
                <div class="pt-4 border-t border-slate-100 flex items-center justify-end gap-3">
                    <a href="{{ $default_class_id ? '/admin/classes/sprints?class_id=' . $default_class_id : '/admin/sprints' }}" 
                       class="px-6 py-2 text-purple-600 font-medium hover:text-purple-900 transition-colors">
                        Cancel
                    </a>
