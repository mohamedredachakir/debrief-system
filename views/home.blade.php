    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <div class="text-center">
            <h1 class="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <span class="block bg-gradient-to-r from-brand-600 via-brand-700 to-slate-800 bg-clip-text text-transparent">
                    Learning Management
                </span>
            </h1>
            <p class="mx-auto mt-6 max-w-2xl text-lg sm:text-xl text-slate-600 leading-relaxed">
                ...
                Streamline your educational workflow with powerful tools for teachers and learners.
            </p>

            <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                @if(isset($_SESSION['user_id']))
                    @if($_SESSION['user_role'] === 'admin')
                        <a href="/admin/dashboard" class="btn btn-primary px-8 py-3 text-lg">
                            Go to Dashboard
                        </a>
                    @elseif($_SESSION['user_role'] === 'teacher')
                        <a href="/teacher/dashboard" class="btn btn-primary px-8 py-3 text-lg">
                            Go to Dashboard
                        </a>
                    @elseif($_SESSION['user_role'] === 'learner')
                        <a href="/learner/dashboard" class="btn btn-primary px-8 py-3 text-lg">
                            Go to Dashboard
                        </a>
                    @endif
                ...
                @else
                    ...
                    <div class="text-sm text-slate-500 self-center sm:self-start sm:mt-4">
                        No account required • Try demo accounts
                    </div>
                @endif
            </div>
        </div>
