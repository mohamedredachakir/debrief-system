...
<div class="relative overflow-hidden">
    ...
    <div class="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%239333ea" fill-opacity="0.03"%3E%3Ccircle cx="30" cy="30" r="4"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-40"></div>
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <div class="text-center">
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-brand-100/80 text-brand-800 text-sm font-medium mb-8">
            ...
            <h1 class="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight">
                <span class="block text-slate-900">Premium</span>
            ...
            <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                @if(isset($_SESSION['user_id']))
                    @if($_SESSION['user_role'] === 'admin')
                        <a href="/admin/dashboard" class="btn btn-primary px-8 py-3 text-lg shadow-2xl shadow-brand-500/25">
                    ...
                    @elseif($_SESSION['user_role'] === 'teacher')
                        <a href="/teacher/dashboard" class="btn btn-primary px-8 py-3 text-lg shadow-2xl shadow-brand-500/25">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @elseif($_SESSION['user_role'] === 'learner')
                        <a href="/learner/dashboard" class="btn btn-primary px-8 py-3 text-lg shadow-2xl shadow-brand-500/25">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                            Learning Hub
                ...
                @else
                    <a href="/login" class="btn btn-primary px-8 py-3 text-lg shadow-2xl shadow-brand-500/25">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-20 grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="card group hover:shadow-xl transition-all duration-300 border-slate-200/60 hover:border-brand-200">
                <div class="flex items-center space-x-3 mb-4">
                    <div class="p-2 bg-brand-100 rounded-lg group-hover:bg-brand-200 transition-colors">
                        <svg class="w-6 h-6 text-brand-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-slate-900">For Teachers</h3>
                </div>
            ...
            <div class="card group hover:shadow-xl transition-all duration-300 border-slate-200/60 hover:border-brand-200">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <h3 class="text-xl font-semibold text-slate-900">For Learners</h3>
                </div>
                <p class="text-slate-600 leading-relaxed">
            ...
            <div class="card group hover:shadow-xl transition-all duration-300 border-slate-200/60 hover:border-brand-200">
                <div class="flex items-center space-x-3 mb-4">
                    ...
                    <h3 class="text-xl font-semibold text-slate-900">For Administrators</h3>
                </div>
                <p class="text-slate-600 leading-relaxed">
        ...
        <div class="mt-20 text-center">
            <div class="inline-flex items-center space-x-6 bg-white/60 backdrop-blur-sm rounded-full px-6 py-3 border border-slate-200/60">
                <div class="flex items-center space-x-2">
                    <div class="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                    <span class="text-sm text-slate-600">System Online</span>
                </div>
