...
@section('content')
<div class="relative overflow-hidden bg-gradient-to-br from-brand-50 via-blue-50 to-indigo-100">
    ...
    <div class="absolute top-20 left-10 w-72 h-72 bg-brand-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"></div>
