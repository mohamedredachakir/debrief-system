...
<div class="min-h-screen bg-gradient-to-br from-brand-50 via-blue-50 to-indigo-100 relative overflow-hidden">
    ...
    <div class="absolute top-20 left-10 w-80 h-80 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
    <div class="absolute bottom-20 right-20 w-80 h-80 bg-brand-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
    <div class="relative">
