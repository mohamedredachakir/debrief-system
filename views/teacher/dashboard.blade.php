...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50 to-fuchsia-100 relative overflow-hidden">
    ...
    <div class="absolute top-20 right-20 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8 gap-4">
            <div>
                ...
                <p class="mt-2 text-purple-600">Manage your sprints, briefs, and student evaluations</p>
            </div>
            <div class="flex items-center gap-3">
                <div class="px-4 py-2 bg-purple-50/80 backdrop-blur-sm rounded-lg border border-purple-200/60">
                    <div class="text-sm text-purple-600">
                        <span class="font-medium text-purple-900">{{ count($sprints ?? []) }}</span> active sprints
                    </div>
                </div>
        ...
        @if($sprints && count($sprints) > 0)
                    ...
                    <div class="card group relative overflow-hidden">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-3">
                                    ...
                                    <div>
                                        <h3 class="text-xl font-semibold text-purple-900 group-hover:text-purple-700 transition-colors">{{ $sprint->name }}</h3>
                        ...
                        @if($sprint->briefs && count($sprint->briefs) > 0)
                            <div class="space-y-4">
                                <div class="flex items-center justify-between">
                                    <h4 class="text-sm font-medium text-purple-700 uppercase tracking-wide">Active Briefs</h4>
                                    <span class="text-xs text-slate-500 bg-purple-100 px-2 py-1 rounded-full">{{ count($sprint->briefs) }} briefs</span>
                                </div>

                                <div class="grid gap-3">
                                    @foreach($sprint->briefs as $brief)
                                        <div class="group/item flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-white rounded-lg border border-purple-200/60 hover:border-purple-200 hover:shadow-sm transition-all duration-200">
                                            <div class="flex items-center space-x-4 flex-1">
                                                <div class="flex-shrink-0">
                                                    <div class="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center group-hover/item:bg-purple-200 transition-colors">
                                                        <svg class="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <h5 class="text-sm font-medium text-purple-900 truncate">{{ $brief->title }}</h5>
                                                    <div class="flex items-center gap-3 mt-1">
                                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {{ $brief->type === 'individuel' ? 'bg-purple-100 text-purple-800' : 'bg-violet-100 text-violet-800' }}">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <svg class="w-4 h-4 text-slate-400 group-hover/item:text-purple-600 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @else
                            <div class="text-center py-12">
                                ...
                                <h3 class="text-lg font-medium text-purple-900 mb-2">No briefs yet</h3>
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="card text-center">
                    ...
                    <h4 class="font-semibold text-purple-900 mb-1">Active Briefs</h4>
                    <p class="text-2xl font-bold text-purple-600">{{ array_sum(array_map(fn($s) => count($s->briefs ?? []), $sprints ?? [])) }}</p>
                </div>
                ...
                <div class="card text-center">
                    ...
                    <h4 class="font-semibold text-purple-900 mb-1">Total Students</h4>
                ...
                <div class="card text-center">
                    ...
                    <h4 class="font-semibold text-purple-900 mb-1">Completion Rate</h4>
        ...
        @else
            <div class="flex flex-col items-center justify-center py-20">
                <div class="text-center max-w-md">
                    ...
                    <h2 class="text-2xl font-bold text-purple-900 mb-3">Welcome to Your Dashboard</h2>
                    <p class="text-purple-600 mb-8">You haven't been assigned to any classes yet. Once your administrator assigns you to classes and creates sprints, you'll see them here.</p>
